...
$namespace = 'Tukecx\Base\Pages\Http\Controllers';
 ...
 * Front site
 */
foreach (config('tukecx-pages.custom_route_locations.web', []) as $file) {
    require $file;
}
foreach (config('tukecx-pages.public_routes.web', []) as $method => $routeInfo) {
